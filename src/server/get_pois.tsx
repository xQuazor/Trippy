...
export async function getPois(latitude: number, longitude: number, radius: number) {
...
function getLocation(photo_id: object) {
    ...
    return fetch(query, { method: "GET" }).then(function(response){
              return response.json()
  }).then(function(data){
      return data
    })
